                      ...
                      while ($row=mysqli_fetch_array($result)) {
                        ...
                        echo "<fieldset>
                            <div class=\"form-group col-lg-12\">
                                ...
                                <input class=\"form-control\" placeholder=\"Community/School Name\" name=\"sname\" maxvalue=\"100\" value=\"$f7\">
                            </div>
                            <div class=\"form-group col-lg-12\">
                                <label>Location:</label>
                                <input class=\"form-control\" placeholder=\"Location\" name=\"slocation\" maxvalue=\"150\" value=\"$f6\">
                            </div>
                            <div class=\"form-group col-lg-12\">
                                <label>Contact Person:</label>
                                <input class=\"form-control\" placeholder=\"Contact Person\" name=\"scontact_person\" maxvalue=\"150\"value=\"$f3\">
                            </div>
                            <div class=\"form-group col-lg-12\">
                                <label>Activity:</label>
                                <select class=\"form-control\" name=\"sactivity\">
                                <option value=\"Ear Screening\">Ear Screening</option>
                                <option value=\"Eye Screening\">Eye Screening</option>
                                <option value=\"Ear and Eye Screening\">Ear and Eye Screening</option>
                            </select>
                            </div>
                            <div class=\"form-group col-lg-12\">
