        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="panel panel-default">
                    ...
                    <?php $pid=$_GET['pid'];?>
                        <form role="form" action="<?php echo "updateearpoa.php?pid=$pid" ?>" method="post">
                        <fieldset>
                        <div class="col-lg-12">
                            <?php
                            ...
                            $query="SELECT * FROM EAR_PLAN WHERE PATIENT_ID=$pid";
                            ...
                            <label>Medical Consultation</label>
                            <label>Remark</label>
                            <input class="form-control" type="text" name="medical" value="<?php echo $a['medical_consult']; ?>"></input>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            ...
                            <label>Date</label>
                            <input class="form-control" type="date" name="cpdate" value="<?php echo $a['cpdate']; ?>"></input>
                            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <label>Date</label>
                            <input class="form-control" type="date" name="admissiondate" value="<?php echo $a['admissiondate']; ?>"></input>
                            </div>
                            
                            <div class="col-lg-6">
                            <label>Admission</label>
                            <label>Remark</label>
                            <input class="form-control" type="text" name="admission" value="<?php echo $a['admission']; ?>"></input>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            ...
                            <label>Date</label>
                            <input class="form-control" type="date" name="dischargedate" value="<?php echo $a['dischargedate']; ?>"></input>
                            </div>
                            
                            <div class="col-lg-6">
                            <label>Discharge</label>
                            <label>Remark</label>
                            <input class="form-control" type="text" name="discharge" value="<?php echo $a['discharge']; ?>"></input>
                            </div>
                        </div>
                       <div class="col-lg-12">
                            ...
                            <label>Date</label>
                            <input class="form-control" type="date" name="followupdate" value="<?php echo $a['followupdate']; ?>"></input>
                            </div>
                            
                            <div class="col-lg-6">
                            <label>Follow-up</label>
                            <label>Remark</label>
                            <input class="form-control" type="text" name="followup" value="<?php echo $a['followup']; ?>"></input>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <textarea class="form-control" rows="4" name="assessment"><?php echo $a['assessment']; ?></textarea>
                        </div>
                        <div class="col-lg-12">
                        <br>
                            <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control col-lg-6" name="interviewer" value="<?php echo $a['interviewed']; ?>"></input>
                            </div>
                        </div>
                        </fieldset>
