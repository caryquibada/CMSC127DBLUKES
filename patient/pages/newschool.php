                    ...
                    <form role="form" action="addS.php" method="post">
                        <fieldset>
                            <div class="form-group col-lg-12">
                                ...
                                <input class="form-control" placeholder="Community/School Name" name="sname" maxvalue="100">
                            </div>
                            <div class="form-group col-lg-12">
                                <label>Location:</label>
                                <input class="form-control" placeholder="Location" name="slocation" maxvalue="150">
                            </div>
                            <div class="form-group col-lg-12">
                                <label>Contact Person:</label>
                                <input class="form-control" placeholder="Contact Person" name="scontact_person" maxvalue="150">
                            </div>
                            <div class="form-group col-lg-12">
