...
$query="SELECT * FROM eye WHERE patient_id=$id";
$result=mysqli_query($connect,$query);
	echo "<tr><td>20/</td><td>	20/</td><td>20/</td><td>20/</td></tr>";
while ($row=mysqli_fetch_array($result)) {
    $f1=$row['lvisual_acuity'];
    $f6=$row['rvisual_acuity'];
    $f2=$row['lwith_pinhole'];
    $f7=$row['rwith_pinhole'];
    $f3=$row['l_rx'];
    $f8=$row['r_rx'];
	$f4=$row['pd'];
	$f5=$row['eye_remark'];
    echo "<tr><td>".$f1."</td><td>".$f6."</td><td>".$f2."</td><td>".$f7."</td><td>".$f3."</td><td>".$f8."</td><td>".$f4."</td><td>".$f5."</td><td><a href=\"eyeup.php?id=$id\"><i class='fa fa-pencil fa-fw'></i></a></td></tr>";
	}
?>
                    	</tbody>
                	</table>
