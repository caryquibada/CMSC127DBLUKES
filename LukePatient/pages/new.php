                        ...
                        <fieldset>
                            <div class="form-group">
                                <div class="form-group col-lg-12">
									...
									<input type="radio" name="student" value="student" onclick="document.getElementById('test').selected=true;document.getElementById('notstudent').disabled=true;document.getElementById('notstudent1').disabled=true;document.getElementById('notstudent2').disabled=true;document.getElementById('notstudent3').disabled=true;document.getElementById('notstudent4').disabled=true;document.getElementById('notstudent5').disabled=true;document.getElementById('notstudent6').disabled=true;document.getElementById('notstudent7').disabled=true;document.getElementById('notstudent8').disabled=true;document.getElementById('notstudent9').disabled=true;document.getElementById('school').disabled=false;" checked>
									Yes
                                    </br>
									<input type="radio" name="student" value="student" onclick="document.getElementById('none').selected=true;document.getElementById('notstudent').disabled=false;document.getElementById('notstudent1').disabled=false;document.getElementById('notstudent2').disabled=false;document.getElementById('notstudent3').disabled=false;document.getElementById('notstudent4').disabled=false;document.getElementById('notstudent5').disabled=false;document.getElementById('notstudent6').disabled=false;document.getElementById('notstudent7').disabled=false;document.getElementById('notstudent8').disabled=false;document.getElementById('notstudent9').disabled=false;document.getElementById('school').disabled=true;">
									No
									</input>
									</br>
                                    </br>
									...
									<select class="form-control" name="school_id" id="school">
								        <?php
                                            ...
                                            while($row=mysqli_fetch_array($result)){
                                                ...
                                                $f2=$row['school_id'];
                                                if(strcmp($f1,'-')==0){
                                                    $menu =$menu."<option value=$f2 id=\"none\">".$f1."</option>";
                                                }else{
                                                    $menu =$menu."<option value=$f2 id=\"test\" selected >".$f1."</option>";
                                                }
