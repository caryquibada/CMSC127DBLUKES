        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="newschool.php"><i class="fa fa-graduation-cap fa-fw"></i> New School</a>
                        </li>
                        <li><a href="new.php"><i class="fa fa-user fa-fw"></i> New Patient</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="records.php"><i class="glyphicon glyphicon-folder-open fa-fw"></i> Student Records</a>
                        </li>
                        <li><a href="recordns.php"><i class="fa fa-briefcase fa-fw"></i> Non-Student Records</a>
                        </li>
                        <li><a href="schools.php"><i class="fa fa-university fa-fw"></i> School Records</a>
                        </li>
                        <li class="divider"></li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="newschool.php"><i class="fa fa-university fa-fw"></i> New School</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="schools.php"><i class="fa fa-university fa-fw"></i> School Records</a>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-folder-open-o fa-fw"></i> Patient Records<span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <a href="records.php"><i class="fa fa-graduation-cap fa-fw"></i> Student</a>
                                        </li>
                                        <li>
                                            <a href="recordns.php"><i class="fa fa-briefcase fa-fw"></i> Non-student</a>
                                        </li>
                                    </ul>
                                </li>
                                </li>
                     ...
                     <?php
                        ...
                        $result=mysqli_query($connect,$sql);
							...
							<div class=\"form-group col-lg-12\">
                                ...
                                <textarea class=\"form-control\" rows=\"3\" name=\"eyeremark\" placeholder = $rem></textarea>
                            </div>
            </div>
            <div class=\"col-lg-6\">
            <div class=\"panel panel-default\">
                ...
                <div class=\"panel-body\">
                    <fieldset>
                            ...
                            <div class=\"form-group col-lg-12\">
                                <label>RX:</label>
                                <input class=\"form-control\" placeholder=$lrx name=\"rxl\">
                            </div>
                            <div class=\"form-group col-lg-12\">
                                <label>PD:</label>
                                <input class=\"form-control\" placeholder=$lpd name=\"pdl\">
                            </div>
                    </fieldset>
                </div>
                </div>
                ...
                <div class=\"panel-body\">
                    <fieldset>
                        <div class=\"form-group col-lg-6\">
                            ...
                            <div class=\"form-group col-lg-12\">
                                <label>RX:</label>
                                <input class=\"form-control\" placeholder=$rrx name=\"rxr\"  >
                            </div>
                            <div class=\"form-group col-lg-12\">
                                <label>PD:</label>
