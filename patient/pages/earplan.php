            ...
            <div class="col-lg-8">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa"></i> Ear Plan of Action
                    </div>
                    <div class="panel-body">
                    <?php $pid=$_GET['pid'];?>
                        <form role="form" action="<?php echo "addearplan.php?pid=$pid" ?>" method="post">
                        <fieldset>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            ...
                            <label>Date</label>
                            <input class="form-control" type="date" name="admissiondate"></input>
                            </div>
                            
                            <div class="col-lg-6">
                            <label>Admission</label>
                            <label>Remark</label>
                            <input class="form-control" type="text" name="admission"></input>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            ...
                            <label>Date</label>
                            <input class="form-control" type="date" name="dischargedate"></input>
                            </div>
                            
                            <div class="col-lg-6">
                            <label>Discharge</label>
                            <label>Remark</label>
                            <input class="form-control" type="text" name="discharge"></input>
                            </div>
                        </div>
                       <div class="col-lg-12">
                            ...
                            <label>Date</label>
                            <input class="form-control" type="date" name="followupdate"></input>
                            </div>
                            
                            <div class="col-lg-6">
                            <label>Follow-up</label>
                            <label>Remark</label>
                            <input class="form-control" type="text" name="followup"></input>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <br>
                            ...
                            <input type="text" class="form-control col-lg-6" name="interviewer"></input>
                            </div>
                        </div>
                        </fieldset>
