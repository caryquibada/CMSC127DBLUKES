...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php"><img align = "left" class="img-responsive img-centered img-xs" style = "width:48px;" src="lukelogo.png">Luke Foundation, Inc. Database</a>
    </div>
                        ...
                        if(!empty($_GET['status'])){
                            ...
                            if($status=='1'){
                                echo "<div class=\"alert alert-success col-lg-8 alert-dismissible\" role=\"alert\">
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">OK</span></button>
                                    <strong>Success!</strong> Community Updated.
                                    </div>";
                            }
                        }
                    ?>
                    ...
                    $result=mysqli_query($connect,$sql);
                      ...
                      echo"
                        <fieldset>
                            ...
                            <input class=\"form-control\" placeholder=\"Present Address\" name=\"praddress\" type=\"text\" value=$f8> 
                        </div>
                        <div class=\"form-group col-lg-12\">
                            <label>Provincial Address:</label>
                            <input class=\"form-control\" placeholder=\"Provincial Address\" name=\"address\" type=\"text\" value=$f9>
                        </div>
                        ";
                        ...
                        <div class=\"form-group col-lg-12\">
                            ...
                            <input class=\"form-control\" placeholder=\"Birth place\"type=\"text\" name=\"birthplace\" value=$f12>
                        </div>
                        <div class=\"form-group col-lg-12\">
                            <label>Religion:</label>
                            <input class=\"form-control\" placeholder=\"Religion\" type=\"text\" name=\"preligion\" value=$f13>
                        </div>
                        <div class=\"form-group col-lg-12\">
                            <label>Occupation:</label>
                            <input class=\"form-control\" placeholder=\"Occupation\" type=\"text\" name=\"occupation\" value=$f14>
                        </div>";
                        echo  "<div class=\"form-group col-lg-12\">
                        <label>Contact No.:</label>
                        <input class=\"form-control\" placeholder=\"Name\" type=\"text\" name=\"contactnumber\" value=$f18>
                    </div>";
                            ?>
                        </fieldset>
