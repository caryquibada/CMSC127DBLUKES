...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <div id="page-wrapper">
		...
		<ul class="nav nav-tabs">
            ...
            <li role="presentation" ><a href="records.php">Community Patient</a></li>
            <li role="presentation" class="active"><a href="#">Non Community Patient</a></li>
        </ul>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        while($items=mysqli_fetch_array($result)){
            ...
            echo $items['unique']." - ".$count['total']."<br/>";
        }
        //Sex count
