...
<!-- END UI THEME EDIT BELOW-->
    ...
    <div id="page-wrapper">
        ...
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="#">Community Patient</a></li>
            <li role="presentation" ><a href="recordns.php">Non Community Patient</a></li>
        </ul> <button type="button" class="btn btn-primary btn-md col-md-offset-11" data-toggle="modal" data-target="#myModal">
                Summary
            </button>
            <div class="form-group col-lg-offset-5">
               ...
               echo" <div class=\"panel-body\">
                ...
                $new_sort_type="asc";
                    ...
                    echo "<th><a href=\"records.php?sort=lname&order=".$new_sort_type."&query=$value&searchcategory=$category\"/>Last Name</th>
            	          <th><a href=\"records.php?sort=fname&order=".$new_sort_type."&query=$value&searchcategory=$category\"/>First Name</th>
                	      <th><a href=\"records.php?sort=minitial&order=".$new_sort_type."&query=$value&searchcategory=$category\"/>MI</th>
                    	  <th><a href=\"records.php?sort=age&order=".$new_sort_type."&query=$value&searchcategory=$category\"/>Age</th>
                	      <th>Sex</th>
						  <th>Ear <br/>Condition</td>
						  <th>Eye <br/>Condition</td>
                    ...
                    if($order=='asc'){
                        ...
                        while ($row=mysqli_fetch_array($result)) {
                            ...
                            if((strcmp($lear,'IC')==0||strcmp($rear,'IC')==0)&&($f17!=1||$f17!=0)){
                                echo "<tr class=\"danger\"><td>".$f3."</td><td>".$f1."</td><td>" .$f2."</td><td>" .$f4."</td><td>" .$f5."</td><td><a href="."'displayEar.php?id=".$f16."';"."><i class='fa fa-volume-up fa-fw'></i></a></td><td><a href="."'displayEye.php?id=".$f16."';"."><i class='fa fa-eye fa-fw'></i></a></td><td><a href="."'update.php?id=".$f16."';"."><i class='fa fa-pencil fa-fw'></i></a></td><td><a href=\"delete.php?id=$f16\" onclick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-times-circle fa-fw'></i></button></td></tr>";
                            }else if((strcmp($lear,'OM')==0||strcmp($rear,'OM')==0)&&($f17!=1||$f17!=0)){
                                echo "<tr class=\"success\"><td>".$f3."</td><td>".$f1."</td><td>" .$f2."</td><td>" .$f4."</td><td>" .$f5."</td><td><a href="."'displayEar.php?id=".$f16."';"."><i class='fa fa-volume-up fa-fw'></i></a></td><td><a href="."'displayEye.php?id=".$f16."';"."><i class='fa fa-eye fa-fw'></i></a></td><td><a href="."'update.php?id=".$f16."';"."><i class='fa fa-pencil fa-fw'></i></a></td><td><a href=\"delete.php?id=$f16\" onclick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-times-circle fa-fw'></i></a></td></tr>";
                            }else if($f17!=1){
                                echo "<tr><td>".$f3."</td><td>".$f1."</td><td>" .$f2."</td><td>" .$f4."</td><td>" .$f5."</td><td><a href="."'displayEar.php?id=".$f16."';"."><i class='fa fa-volume-up fa-fw'></i></a></td><td><a href="."'displayEye.php?id=".$f16."';"."><i class='fa fa-eye fa-fw'></i></a></td><td><a href="."'update.php?id=".$f16."';"."><i class='fa fa-pencil fa-fw'></i></a></td><td><a href=\"delete.php?id=$f16\" onclick=\"return confirm('Are you sure you want to delete?')\"><i class='fa fa-times-circle fa-fw'></i></a></td></tr>";
	                        }
                        }
                        ?>
                    	</tbody>
