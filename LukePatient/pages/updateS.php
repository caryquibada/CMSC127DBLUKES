            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   <?php
                        ...
                        echo "<form role=\"form\" action=\"updatesqlSchool.php?id=$id\" method=\"post\">";
                    if(!$connect){
                      ...
                      while ($row=mysqli_fetch_array($result)) {
                        ...
                        echo "<fieldset>
                            <div class=\"form-group col-lg-12\">
                                ...
                                <input class=\"form-control\" placeholder=\"School Name\" name=\"sname\" value=\"$f7\">
                            </div>
                            <div class=\"form-group col-lg-12\">
                                <label>Location:</label>
                                <input class=\"form-control\" placeholder=\"Location\" name=\"slocation\" value=\"$f6\">
                            </div>
                            <div class=\"form-group col-lg-12\">
                                <label>Contact Person:</label>
                                <input class=\"form-control\" placeholder=\"Contact Person\" name=\"scontact_person\" value=\"$f3\">
                            </div>
                            <div class=\"form-group col-lg-12\">
                                <label>Activity:</label>
                                <input class=\"form-control\" placeholder=\"Activity\" name=\"sactivity\" value=\"$f4\">
                            </div>
                            <div class=\"form-group col-lg-12\">
                                <label>Date visited:</label>
                                <input class=\"form-control\" placeholder=\"saka ko na aayusin\" type=\"date\" name=\"datevisited\" value=\"$f5\">
                            </div>
                        </fieldset>";
                        ?>
